...
resources.
* [GitHub](https://github.com) is an essential tool for code development and collaboration. See the [Pro Git](https://git-scm.com/book/en/v2) online book to learn more about git and GitHub, or our [Git with RStudio](resources/GitRStudioDoc.pdf) documentation for tips on working with git in RStudio and resolving conflicts with another user.
