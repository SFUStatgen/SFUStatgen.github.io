...
resources.
* [GitHub](https://github.com) is an essential tool for code development and collaboration based on a version control system called git. The [Pro Git](https://git-scm.com/book/en/v2) online book is the user manual for git and GitHub. Most of us use the [RStudio/git interface](https://support.rstudio.com/hc/en-us/articles/200532077-Version-Control-with-Git-and-SVN). See our [Git with RStudio](resources/GitRStudioDoc.pdf) documentation for tips on working with git in RStudio and resolving conflicts that can arise when working with collaborators.
