...
resources.
* [GitHub](https://github.com) is an essential tool for code development and collaboration. Most of us use the [RStudio/git interface](https://support.rstudio.com/hc/en-us/articles/200532077-Version-Control-with-Git-and-SVN). See the [Pro Git](https://git-scm.com/book/en/v2) online book to learn about git and GitHub, or our [Git with RStudio](resources/GitRStudioDoc.pdf) documentation for tips on working with git in RStudio and resolving conflicts that can arise when working with collaborators.
